...
describe('schemaVisitor', () => {
  describe('getVisitKinds()', () => {
    ...
    it('empty array on unexpected object', () => {
      expect(getVisitKinds(({}: any), schemaComposer)).toEqual([]);
      expect(getVisitKinds((false: any), schemaComposer)).toEqual([]);
      expect(getVisitKinds((null: any), schemaComposer)).toEqual([]);
      expect(getVisitKinds((undefined: any), schemaComposer)).toEqual([]);
      expect(getVisitKinds(('abc': any), schemaComposer)).toEqual([]);
    });
  });
